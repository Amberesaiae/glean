...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      deals: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "deals_proposer_id_fkey"
            columns: ["proposer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      drive_commitments: {
        ...
        Relationships: [
          {
            foreignKeyName: "drive_commitments_drive_id_fkey"
            columns: ["drive_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "drive_commitments_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      drives: {
        ...
        Relationships: [
          {
            foreignKeyName: "drives_organizer_id_fkey"
      ...
      feed_flags: {
        ...
        Relationships: [
          {
            foreignKeyName: "feed_flags_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "feed_posts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "feed_flags_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      hub_follows: {
        ...
        Relationships: [
          {
            foreignKeyName: "hub_follows_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      seed_demo_deal: { Args: never; Returns: undefined }
      seed_demo_fulfilled: { Args: never; Returns: undefined }
      seed_demo_threads: { Args: never; Returns: undefined }
      st_3dclosestpoint: {
        Args: { geom1: unknown; geom2: unknown }
        Returns: unknown
      }
